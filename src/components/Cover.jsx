    ...
    <div className='flex justify-center items-center h-screen bg-cover bg-center bg-no-repeat bg-light dark:bg-dark font-display'>
      ...
      {image && (
        ...
        <div className='flex justify-center'>
            <Link href='mailto:yana.korobeinyk@gmail.com' aria-label="Contact me per email"  className='absolute bottom-10 z-[2] px-8 py-2 text-light border bg-tomatoes border-tomatoes rounded hover:bg-hover hover:border-none uppercase'>{button} </Link>
        </div>
      </div>
    </div>
  )
