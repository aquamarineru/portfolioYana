...
function Error404() {
  return (
    <div className="flex items-center justify-center flex-col h-screen text-center font-sans text-gray-500 m-0">
            ...
            <Link href="/" className='mt-10 px-8 py-2 text-light border bg-tomatoes border-tomatoes rounded hover:bg-hover hover:border-none font-ricordi uppercase'> Go back </Link>
    </div>
  )
}
